...
class _AuctionResult_0 {
  alignment() {
    return _descriptor_0.alignment().concat(_descriptor_2.alignment().concat(_descriptor_1.alignment()));
  }
  fromValue(value_0) {
    return {
      hasWinner: _descriptor_0.fromValue(value_0),
      winningBidder: _descriptor_2.fromValue(value_0),
      winningBid: _descriptor_1.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.hasWinner).concat(_descriptor_2.toValue(value_0.winningBidder).concat(_descriptor_1.toValue(value_0.winningBid)));
  }
}
...
class _tuple_0 {
  ...
  toValue(value_0) {
    return _descriptor_1.toValue(value_0[0]).concat(_descriptor_2.toValue(value_0[1]));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      submitBid: async (...args_1) => {
        ...
        const result_0 = await this._submitBid_0(context,
                                                 partialProofData,
                                                 commitment_0);
      ...
      closeAuction: async (...args_1) => {
        ...
        const result_0 = await this._closeAuction_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        __compactRuntime.finalizeCallProofData(context, partialProofData);
        return { result: result_0, context: context, gasCost: context.callContext.currentGasCost };
      },
      revealBid: async (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(bid_0).concat(_descriptor_2.toValue(nonce_0)),
      ...
      closeReveal: async (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`closeReveal: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
        ...
        const result_0 = await this._closeReveal_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        __compactRuntime.finalizeCallProofData(context, partialProofData);
        return { result: result_0, context: context, gasCost: context.callContext.currentGasCost };
      },
      determineWinner: async (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`determineWinner: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('determineWinner',
                                     'argument 1 (as invoked from Typescript)',
                                     'auction.compact line 80 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = __compactRuntime.copyCircuitContext(contextOrig_0);
        ...
        const result_0 = await this._determineWinner_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        __compactRuntime.finalizeCallProofData(context, partialProofData);
        return { result: result_0, context: context, gasCost: context.callContext.currentGasCost };
      },
      finalizeAuction: async (...args_1) => {
        if (args_1.length !== 1) {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('finalizeAuction',
                                     'argument 1 (as invoked from Typescript)',
                                     'auction.compact line 95 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = __compactRuntime.copyCircuitContext(contextOrig_0);
        ...
        const result_0 = await this._finalizeAuction_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        __compactRuntime.finalizeCallProofData(context, partialProofData);
        return { result: result_0, context: context, gasCost: context.callContext.currentGasCost };
      },
      getAuctionResult: async (...args_1) => {
        if (args_1.length !== 1) {
        ...
        const result_0 = await this._getAuctionResult_0(context,
                                                        partialProofData);
  ...
  async _submitBid_0(context, partialProofData, commitment_0) {
  ...
  async _closeAuction_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
  ...
  async _revealBid_0(context, partialProofData, bid_0, nonce_0) {
    __compactRuntime.assert(!_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
    ...
    const computedCommitment_0 = this._persistentHash_0([bid_0, nonce_0]);
    const storedCommitment_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                         partialProofData,
                                                                                         [
                                                                                          { dup: { n: 0 } },
                                                                                          { idx: { cached: false,
  ...
  async _closeReveal_0(context, partialProofData) {
    __compactRuntime.assert(!_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
  ...
  async _determineWinner_0(context, partialProofData) {
    __compactRuntime.assert(!_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
  ...
  async _finalizeAuction_0(context, partialProofData) {
    __compactRuntime.assert(!_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
  ...
  async _getAuctionResult_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
